 ...
 **********************************************************************************/
volatile OS_TASK_MANAGER_t task_manager;
...
extern volatile APPLICATION_TASK_t* Queue_InitializeSequence[];
extern volatile uint16_t Queue_InitializeSequence_Size; 

extern volatile APPLICATION_TASK_t* Queue_StartSequence[];
extern volatile uint16_t Queue_StartSequence_Size; 

extern volatile APPLICATION_TASK_t* Queue_ExecuteSequence[];
extern volatile uint16_t Queue_ExecuteSequence_Size; 

extern volatile APPLICATION_TASK_t* Queue_StopSequence[];
...
static volatile APPLICATION_TASK_t** exec_queues[] = {
...
struct OS_TASK_QUEUE_s {
    volatile APPLICATION_TASK_t** ptrQueue;  ///< Pointer to task queue
...
struct OS_TASK_QUEUES_s {
    ...
    volatile OS_TASK_QUEUE_t queues[NO_OF_TASK_QUEUES];
};
...
static volatile OS_TASK_QUEUES_t os_queues;
...
static volatile uint16_t rtos_Initialize(void)
{
    ...
    {
        os_queues.queues[_i].ptrQueue = (volatile APPLICATION_TASK_t**)exec_queues[_i];
