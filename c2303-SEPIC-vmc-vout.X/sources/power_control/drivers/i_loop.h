 ...
 * @ingroup special-function-layer-npnz16-functions
 * @brief Prototype of the Assembler routine '_i_loop_Reset' clearing the NPNZ16b controller output and error histories
 ...
 ********************************************************************************/
extern void i_loop_Reset(                         // i_loop reset function call (Assembler)
        volatile struct NPNZ16b_s* controller     // Pointer to NPNZ16b data object
    );
 ...
 * @ingroup special-function-layer-npnz16-functions
 * @brief Prototype of the Assembler routine '_i_loop_Precharge' loading user-defined values into the NPNZ16b  controller output and error histories
 * @param controller: Pointer to NPNZ16b data object of type struct NPNZ16b_s*
 ...
 ********************************************************************************/
extern void i_loop_Precharge(                     // i_loop history pre-charge function call (Assembler)
        volatile struct NPNZ16b_s* controller,    // Pointer to NPNZ16b data object
 ...
 * @ingroup special-function-layer-npnz16-functions
 * @brief Prototype of the Assembler feedback control loop routine helping to call the i_loop controller from C-code
 * @param controller: Pointer to NPNZ16b data object of type struct NPNZ16b_s*
 *
 * @details
 ...
 ********************************************************************************/
extern void i_loop_Update(                        // Calls the 2P2Z controller (Assembler)
        volatile struct NPNZ16b_s* controller     // Pointer to NPNZ16b data object
    );
